...
export function formatCandidates(candidates) {
  return candidates.map((c) => ({
    ...
    about: c.about || null,
    workHistory: Array.isArray(c.workHistory) ? c.workHistory : [],
    educationHistory: Array.isArray(c.educationHistory) ? c.educationHistory : [],
    certifications: Array.isArray(c.certifications) ? c.certifications : [],
    languages: Array.isArray(c.languages) ? c.languages : [],
    scrapingDogEnriched: Boolean(c._scrapingDogEnriched),
