            ...
            ${
				...
				<div className="flex items-center gap-4">
					...
					<div className="hidden sm:flex items-center gap-2 bg-slate-100/80 p-1 rounded-full shadow-inner">
						...
						<button className="flex items-center gap-1 px-3 py-1.5 text-xs font-semibold text-white bg-green-400 hover:bg-green-600 rounded-full shadow-md transition-all cursor-pointer">
							<Plus size={14} />
							BUY
						</button>
					</div>
