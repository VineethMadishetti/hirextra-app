          ...
          {user?.role === 'ADMIN' && (
            <div className="hidden md:flex bg-gray-100 p-1 rounded-lg">
              <NavLink
                ...
                className={({ isActive }) => `flex items-center gap-2 px-4 py-2 rounded-md text-sm font-semibold transition-all duration-200 ${isActive ? 'bg-white text-accent shadow-sm ring-1 ring-gray-200' : 'text-gray-500 hover:text-gray-900'}`}
              >
